            ...
            Confirm.show('溫馨提示', '您確定要刪除' + name + '嗎？', {
                'Delete': {
                    ...
                    'callback': function () {
                        ...
                        $.post("${pageContext.request.contextPath}/video/videoDel", i, function (data) {
                            if (data == 'success') {
...
<div class="container" style="margin-top: 20px;">
    ...
    <form id="form2" action="${pageContext.request.contextPath}/video/delBatchVideos" method="post">
        <table class="table table-bordered table-hover"
            ...
            <tbody>
            <c:forEach items="${page}" var="video" varStatus="status">
                <tr>
...
<center>
    <div id="page">
        <tr>
            ...
            <a href="javascript:void(0)" onclick="queryVideo(${pageInfo.pageNum-1})">&nbsp;&nbsp;&nbsp;上一页&nbsp;&nbsp;&nbsp;</a>
            <td>&nbsp;&nbsp;&nbsp;当前第${pageInfo.pageNum}/${pageInfo.pages}页&nbsp;&nbsp;&nbsp;</td>
            <a href="javascript:void(0)" onclick="queryVideo(${pageInfo.pageNum+1})">&nbsp;&nbsp;&nbsp;下一页&nbsp;&nbsp;&nbsp;</a>
            <a href="javascript:void(0)" onclick="queryVideo(${pageInfo.pages})">&nbsp;&nbsp;&nbsp;尾页&nbsp;&nbsp;&nbsp;</a>
        </tr>
    </div>
</center>
</body>
